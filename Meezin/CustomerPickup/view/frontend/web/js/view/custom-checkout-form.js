...
define([
    ...
    'Meezin_CustomerPickup/js/model/checkout/custom-checkout-form',
    'Magento_Checkout/js/model/step-navigator'
], function(ko, $, urlFormatter, Component, customer, quote, urlBuilder, errorProcessor, cartCache, formData, stepNavigator) {
'use strict';
